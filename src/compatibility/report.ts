...
import { categorize, Categorizer, ChangeType } from "./categorizer"
...
export class CategorizedChanges {
  ...
  static fromReports(
    ...
    return new CategorizedChanges(storage, major as any, minor, patch)
  }
...
export class ASTDetailedVersionedReport {
  ...
  versionDeltas = (): ContractVersionDeltaIndex => {
    const deltas: Record<string, ContractVersionDelta> = {}
