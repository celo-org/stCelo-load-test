...
import { CeloContractName } from "./registry-utils"
...
const DefaultConfig = {
  ...
  blockchainParameters: {
    gasForNonGoldCurrencies: 50_000,
    minimumClientVersion: {
      major: 1,
      minor: 0,
      patch: 0,
    },
    deploymentBlockGasLimit: 20_000_000,
    blockGasLimit: 13_000_000,
  ...
  reserve: {
    ...
    tobinTax: toFixed(0).toFixed(0), // Tobin tax turned off to start
    tobinTaxReserveRatio: toFixed(0).toFixed(0), // Tobin tax turned off to start
    dailySpendingRatio: toFixed(0.05).toFixed(0), // 5%
...
const NetworkConfigs: Record<string, any> = {
  ...
  testing: {
    ...
    reserve: {
      initialBalance: 100_000_000, // CELO
    },
  },
  baklava: {
    downtimeSlasher: {
    ...
    reserve: {
      initialBalance: 100_000_000, // CELO
      frozenAssetsStartBalance: 80_000_000, // Matches Mainnet after CGP-6
