import {
  ...
  Delta,
  DeltaUtil,
} from "../../src/compatibility/version"
...
describe("#version()", () => {
  ...
  describe("ContractVersionDelta", () => {
    describe("ContractVersionDelta.fromChanges", () => {
      it("properly sets the storage Delta 1", () => {
      ...
      it("properly sets the storage Delta 2", () => {
      ...
      it("properly sets the major Delta 1", () => {
  ...
  describe("ContractVersionChecker", () => {
    ...
    describe("when the old version is null", () => {
      ...
      const cvc = new ContractVersionChecker(null as any, newVersion, cvd)
