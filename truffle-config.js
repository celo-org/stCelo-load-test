...
const ALFAJORES_NETWORKID = 44_787
const BAKLAVA_NETWORKID = 62_320
const BAKLAVASTAGING_NETWORKID = 31_420
...
const gasLimit = 13_000_000
const hostAddress = process.env.CELO_NODE_ADDRESS || "127.0.0.1"
const hostPort = Number.parseInt(process.env.CELO_NODE_PORT || "8545")
